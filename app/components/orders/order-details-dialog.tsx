        ...
        <ScrollArea className="h-[calc(100vh-6rem)] sm:h-[calc(90vh-7rem)] px-4 sm:px-6 py-4">
          <div className="space-y-4 sm:space-y-5 pb-4 sm:pb-6">
            ...
            <section className="space-y-3">
              ...
              <div className="p-3 sm:p-4 bg-gradient-to-br from-gray-50/50 via-white/50 to-gray-50/50 dark:from-gray-800/50 dark:via-gray-800/30 dark:to-gray-800/50 rounded-lg border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm shadow-sm">
